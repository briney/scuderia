...
SCHEMA=dict(name='paper_enrichment',description=(
    ...
    'attempt_dir is new, external, with an existing parent. export preserves unresolved and unreviewed scope. '
    'Exact use needs source inspection or qualification; algorithm-specification always needs inspection. '
    'Returns actual child exit and hash-checked artifact receipt, not a scientific correctness claim.'),
