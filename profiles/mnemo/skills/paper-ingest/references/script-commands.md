...
| `final_products.py` | `ingest` finalizes verified source/enrichment products; `publish-ingest --manifest ... --receipt ... --remote ... --bucket ... --prefix ...` publishes and saves a durable read-back receipt. Parent `verify_ingest.py --final-products ... --publication-receipt ... --require-enriched-source` requires it before completion. |
